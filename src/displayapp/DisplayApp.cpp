...
void DisplayApp::LoadScreen(Apps app, DisplayApp::FullRefreshDirections direction) {
  ...
  switch (app) {
    ...
    case Apps::Paddle:
      ...
      break;
    case Apps::Music:
      currentScreen = std::make_unique<Screens::Music>(systemTask->nimble().music(), batteryController, bleController);
      break;
    case Apps::Navigation:
      currentScreen = std::make_unique<Screens::Navigation>(systemTask->nimble().navigation());
      break;
    case Apps::HeartRate:
      currentScreen = std::make_unique<Screens::HeartRate>(heartRateController, batteryController, bleController, *systemTask);
      break;
    case Apps::Metronome:
      currentScreen = std::make_unique<Screens::Metronome>(motorController, *systemTask);
      break;
    case Apps::Steps:
      currentScreen = std::make_unique<Screens::Steps>(motionController, settingsController, batteryController, bleController);
      break;
  }
  currentApp = app;
}
